import 'dart:convert';
import 'package:c_19/config.dart';
import 'package:c_19/widgets/prevention_card.dart';
import 'package:c_19/widgets/service_card.dart';
import 'package:c_19/widgets/starts_card.dart';
            ...
            LimitedBox(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  PreventionCard(
                    imageUrl:
                        'https://assets.teenvogue.com/photos/5b3911ff155483623a8837ad/16:9/w_2560%2Cc_limit/GettyImages-476804983.jpg',
                    title: 'Wash Hands Often',
                  ),
                  PreventionCard(
                    imageUrl:
                        'https://menorahmanor.org/sites/default/files/styles/large/public/field/image/social_distance.png?itok=EL0Ns6JO',
                    title: 'Keep Social Distance',
                  ),
                  PreventionCard(
                    imageUrl:
                        'https://digitalagencynetwork.com/wp-content/uploads/2020/05/memorable-stay-home-ad-campaigns-by-brands-for-covid-19.jpg',
                    title: 'Stay at home',
                  ),
                  PreventionCard(
                    imageUrl:
                        'https://www.sfcdcp.org/wp-content/uploads/2017/12/iStock-182423254-830x425.jpg',
